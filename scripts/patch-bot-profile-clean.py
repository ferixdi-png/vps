...
# profile_links(): keep the HTTPS hostname only for the subscription URL.
# The VLESS endpoints themselves must point directly to the node IP.
...
new_url = '''    return f"{PUBLIC_SCHEME}://{host}{port}/sub/{row['sub_token']}?rev=rawip-20260915"\n'''
